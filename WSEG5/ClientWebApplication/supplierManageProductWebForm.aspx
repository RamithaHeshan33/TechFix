<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="supplierManageProductWebForm.aspx.cs" Inherits="ClientWebApplication.supplierManageProductWebForm" %>
        ...
        <div class="container">
            ...
            <table>
                <tr>
                    ...
                    <td> <asp:TextBox ID="txtProdName" runat="server"></asp:TextBox> </td>
                    <td><asp:Button ID="btnSearchByProdName" runat="server" Text="Search" CssClass="btnSearch" OnClick="btnSearchByProdName_Click" /></td>
